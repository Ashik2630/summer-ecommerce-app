...
const PopularProducts = async () => {
  ...
  return (
    <div className="container mx-auto   mb-50">
      <div className="flex justify-between mt-16 mb-5 text-[#1d9e75]">
        <h2 className="text-2xl font-bold  mx-5 md:mx-0">
          PopularProducts
        </h2>
        <Link
          className="flex items-center gap-2 mx-5 md:mx-0 font-bold"
          href={`/products`}
        >
